...
const char HEADER_TEMPLATE[] PROGMEM = R"ADMINUI(<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body><div class="container">)ADMINUI";
const char EVIL_TWIN_HTML[] PROGMEM = R"EVILTWINHTML(<!DOCTYPE html>
<html>
<head>
